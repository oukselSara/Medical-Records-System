...
const SignupPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Store user role
      localStorage.setItem(`user_role_${result.user.uid}`, formData.role);

      showToast(
        "Account created!",
        "Welcome to MediCare EMR. You can now access the dashboard.",
      );
              ...
              <div className="p-8">
                ...
                <div className="mb-8">
                  ...
                  <p className="text-gray-600 dark:text-gray-300">
                    Join MediCare EMR to manage medical records
                  </p>
                </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative group">
                      ...
                      <select
                        ...
                        onBlur={() => setFocusedField(null)}
                        className="w-full pl-12 pr-4 py-3 rounded-xl backdrop-blur-sm bg-white/50 dark:bg-gray-800/50 border-2 border-pink-200/50 dark:border-pink-500/30 focus:border-pink-400 dark:focus:border-pink-400 focus:bg-white dark:focus:bg-gray-800/80 text-gray-800 dark:text-gray-100 transition-all duration-300 ease-in-out focus:shadow-lg focus:shadow-pink-500/20 dark:focus:shadow-pink-500/40 outline-none appearance-none cursor-pointer"
                      >
